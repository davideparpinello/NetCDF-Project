...
int main(int argc, char *argv[])
{
    ...
    while ((de = readdir(dr)) != NULL)
        if (de->d_type == DT_REG)
        {
            char name[] = "NetCDF-Project/CMCC-CM2-SR5_historical/";
    ...
    for (counter = 0; counter < file_count; counter++)
    {
        ...
        if (strcmp(filename, "pr_day_CMCC-CM2-SR5_historical_r1i1p1f1_gn_20000101-20141231.nc") != 0)
            nrec = 9125;
        else
            nrec = 5475;
        ...
        */
        ...
        if (rank == 0)
        {
            ...
            medie_finali[counter] = somma_finale;
